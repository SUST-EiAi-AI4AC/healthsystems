...
- 历史记录与趋势分析
- ECharts 图表可视化展示
- **量表答题体验优化** - 选项支持**整行卡片区域点击选中**（单选范围扩大至 100%），并且移除了传统的绝对底部悬浮按钮，使“上一题”、“下一题”与“提交”按钮紧随题目后方，在各尺寸屏幕下都更美观且易于操作。
...
| 子模块 | 功能描述 |
|--------|---------|
| **聊天** | "心晴" AI 心理助手。对接 ModelScope `MiniMax-M2.5` 大模型，实时生成温暖共情且适度简炼（控制在 100 字内）的陪伴回复；无缝对接 `stepaudio-2.5-tts`，并在对话顶栏提供磨砂玻璃质感的“音量开关”按钮，支持全局语音开启/关闭与播放控制。 |
