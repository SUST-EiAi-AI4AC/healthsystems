...
import com.nwpu.healthsystem.backend.service.scale.IpaqService;
...
@Api(value = "")
@RestController
@RequestMapping("/scale/ipaq")
public class IpaqController {
    @Autowired
    private IpaqService service;
    ...
    public Response add(@RequestBody Ipaq ipaq) {
        return service.addOrUpdate(ipaq);
    }
