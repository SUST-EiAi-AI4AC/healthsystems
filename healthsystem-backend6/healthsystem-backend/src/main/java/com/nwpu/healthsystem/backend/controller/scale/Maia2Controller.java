...
import com.nwpu.healthsystem.backend.service.scale.Maia2Service;
...
@Api(value = "")
@RestController
@RequestMapping("/scale/maia2")
public class Maia2Controller {
    @Autowired
    private Maia2Service service;
    ...
    public Response add(@RequestBody Maia2 m) {
        return service.addOrUpdate(m);
    }
