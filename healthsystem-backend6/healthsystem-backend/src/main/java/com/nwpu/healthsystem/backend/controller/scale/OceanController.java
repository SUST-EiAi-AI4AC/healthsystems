...
import com.nwpu.healthsystem.backend.service.scale.OceanService;
...
public class OceanController {
    ...
    public Response add(@RequestBody Ocean o) {
        return service.addOrUpdate(o);
    }
