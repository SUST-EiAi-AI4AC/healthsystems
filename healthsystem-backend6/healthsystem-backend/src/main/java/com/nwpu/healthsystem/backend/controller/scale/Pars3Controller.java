...
import com.nwpu.healthsystem.backend.service.scale.Pars3Service;
...
@Api(value = "")
@RestController
@RequestMapping("/scale/pars3")
public class Pars3Controller {
    @Autowired
    private Pars3Service service;
    ...
    public Response add(@RequestBody Pars3 p) {
